      ...
      <main>
        <section className="mx-auto max-w-5xl px-6 pb-14 pt-16 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <LinkButton href="#offerte-assistent" size="lg">Bekijk de AI-offerte-assistent</LinkButton>
            <LinkButton href="/login" size="lg" variant="outline">Registreer je bedrijf</LinkButton>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-3xl px-6 pb-20">
          <Card className="bg-ink text-paper">
            ...
            <Link href="/login" className="mt-4 inline-flex items-center gap-1.5 text-sm font-medium text-coral">
