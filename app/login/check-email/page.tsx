...
export default async function CheckEmailPage(props: PageProps<"/login/check-email">) {
      ...
      <div className="w-full max-w-sm text-center">
        ...
        <div className="rounded-2xl border border-line bg-white p-8 [box-shadow:var(--shadow-card)]">
          ...
          <p className="mt-2 text-sm text-ink-soft">
            We hebben een inloglink gestuurd naar {email ? <strong>{email}</strong> : "je e-mailadres"}. Klik op de link in die e-mail om in te loggen.
          </p>
