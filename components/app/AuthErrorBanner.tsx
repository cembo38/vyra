const MESSAGES: Record<string, string> = {
  ...
  config_error: "Inloggen/registreren is momenteel niet beschikbaar door een technisch probleem bij Vyra. We zijn hiermee bezig — probeer het over een paar minuten opnieuw.",
