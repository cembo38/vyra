...
export default async function SupplierCheckEmailPage(props: PageProps<"/supplier/signup/check-email">) {
      ...
      <div className="w-full max-w-sm text-center">
        ...
        <div className="rounded-2xl border border-line bg-white p-8 [box-shadow:var(--shadow-card)]">
          ...
          <p className="mt-2 text-sm text-ink-soft">
            We hebben een bevestigingslink gestuurd naar {email ? <strong>{email}</strong> : "je e-mailadres"}. Klik op de link in die e-mail om je leveranciersaccount te activeren — daarna richt je meteen je bedrijfsprofiel in.
          </p>
